...
public enum ChatStates {
    ...
    WAITING_FOR_NAME("/new_patient"), WAITING_FOR_SECONDNAME("/new_patient"), WAITING_FOR_DISEASE("/new_patient"), WAITING_FOR_PATIENT_STATE("/new_patient"), WAITING_FOR_CHAMBER_NUMBER("/new_patient"), WAITING_FOR_DESCRIPTION("/new_patient"), WAITING_FOF_APPROVE("/new_patient"),
    WAITING_FOF_NAME_UPDATE("/new_patient"), WAITING_FOF_SECONDNAME_UPDATE("/new_patient"), WAITING_FOF_DISEASE_UPDATE("/new_patient"), WAITING_FOF_STATE_UPDATE("/new_patient"), WAITING_FOF_CHAMBER_UPDATE("/new_patient"), WAITING_FOF_DESCRIPTION_UPDATE("/new_patient"),
